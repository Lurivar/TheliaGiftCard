...
class GiftCardInfoCartTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('CART_ID', 'CartId', 'INTEGER', 'cart', 'ID', false, null, null);
        $this->addForeignKey('CART_ITEM_ID', 'CartItemId', 'INTEGER', 'cart_item', 'ID', false, null, null);
        $this->addColumn('SPONSOR_NAME', 'SponsorName', 'VARCHAR', false, 250, null);
        $this->addColumn('BENEFICIARY_NAME', 'BeneficiaryName', 'VARCHAR', false, 250, null);
        $this->addColumn('BENEFICIARY_MESSAGE', 'BeneficiaryMessage', 'VARCHAR', false, 500, null);
    } // initialize()
